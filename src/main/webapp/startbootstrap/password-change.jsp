...
<head>
    ...
    <!-- Update password css -->
    <link href="${pageContext.request.contextPath}/startbootstrap/css/update_password.css" rel="stylesheet">
                                ...
                                <div class="card h-100">
                                    <div class="card-body">
                                        <div class="account-settings">
                                            ...
                                            <div class="about">
                                                <h5>About</h5>
                                                <p>I'm ${user.firstName} ${user.lastName}. <fmt:message key="about.me"/> </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                <div class="card h-100">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="first_name" name="first_name"
                                                           placeholder="Enter First name" value="${user.firstName}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="last_Name" name="last_name"
                                                           placeholder="Enter Last name" value="${user.lastName}" readonly>
                                                </div>
                                            </div>
                                    ...
                                    <form action="${pageContext.request.contextPath}/controller" method="post">
                                        ...
                                        <div class="row gutters">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <h6 class="mt-3 mb-2 text-primary"><fmt:message key="password.change"/></h6>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="current_password"><fmt:message key="current.password"/></label>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="confirm_new_password"><fmt:message key="confirm.new.password"/></label>
                                                    <input type="password" name="confirm_new_password" class="form-control"
                                                           placeholder="Repeat new password... " id="confirm_new_password">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="submit"><fmt:message key="password"/></label><br>
                                                        <button class="btn btn-outline-primary" id="submit" name="submit" type="submit"><fmt:message key="update.password"/></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
