        ...
        <div id="content">
            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <form action="${pageContext.request.contextPath}/controller" method="post" >
                    <h1 class="h3 mb-4 text-gray-800"><fmt:message key="write.prescription" /></h1>
                    <div class="container">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                <label for="posted_time"><fmt:message key="posted.time" /></label>
                                        ...
                                        <div class="row gutters">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="illness_description"><fmt:message key="illness.description" /></label>
                                                    <textarea name="illness_description" cols="88" readonly id="illness_description"
                                                              rows="7">${temp_request_receipt.illnessDescription}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row gutters">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="receipt_usage"><fmt:message key="usage.rules" /></label>
                                        ...
                                        <div class="row gutters">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="text-right">
                                                    ...
                                                    <button type="submit" id="submit" name="submit" class="btn btn-primary"><fmt:message key="write.prescription" /></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
