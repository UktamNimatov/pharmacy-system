        ...
        <div id="content">
            ...
            <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <form action="${pageContext.request.contextPath}/controller" method="post" >
                    <h1 class="h3 mb-4 text-gray-800"><fmt:message key="ask.for.receipt"/> </h1>
                    <div class="container">
                            ...
                            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <div class="row gutters">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <h6 class="mt-3 mb-2 text-primary"><fmt:message key="illness.description" /></h6>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="description"><fmt:message key="description" /></label>
                                                    <textarea name="illness_description" id="description" cols="88" rows="7"
...
<%--                                                    <input type="hidden" value="add_request_receipt" name="command">--%>
                                                    <button class="btn btn-outline-primary" id="back_home"
                                                            type="button" onclick="window.location.href='${pageContext.request.contextPath}/startbootstrap/home.jsp'"><fmt:message key="homepage.title" /></button>
                                                    <button type="submit" id="submit" name="submit" class="btn btn-primary"><fmt:message key="post.complaint" /></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
