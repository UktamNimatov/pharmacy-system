...
<meta charset="utf-8">
    ...
    <title><fmt:message key="404.page" /></title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        <div class="error mx-auto" data-text="404"><fmt:message key="404.page"/> </div>
                        <p class="lead text-gray-800 mb-5"><fmt:message key="page.not.found"/> </p>
